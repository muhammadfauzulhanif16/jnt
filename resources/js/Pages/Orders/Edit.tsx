...
const EditOrder: FC<any> = (props: any) => {
    ...
    const form = useForm<z.infer<typeof formSchema>>({
        ...
        defaultValues: {
            customer_id: props.customers[0]?.value || "",
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        router.put(route("orders.update", props.order.id), values);
    }
                            ...
                            <div className="flex flex-col gap-2">
                                {fields.map((item, id) => (
                                    <FormField
                                        ...
                                        control={form.control}
                                        name={
                                            `items.${id}.receipt_number` as const
                                        }
                                        render={({ field }) => (
